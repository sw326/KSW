...
<html>
  ...
  <body>
    <center>
	  ...
	  <hr width="600" color="Maroon" size="2" noshade>
      <!-------------------- re 변화 1 ------------------------------->
	  <form name="input" action="rb-insert.do?method=insert" method="post" enctype="multipart/form-data">
	  <!-------------------------------------------------------------->
	    ...
	    <table align="center" width="600" cellspacing="1" 
		  ...
		  <tr>
			...
			<td align="center" width="80%">
			  <input type="text" name="subject" value="${param.subject}" size="60">
			</td>
		  </tr>
		  <tr>
		    <td align="center" width="20%">내용</td>
			<td align="center" width="80%">
			  <textarea name="content" rows="10" cols="60">${param.content}</textarea>
			</td>
		  </tr>
		  <tr>
		    <td align="center" width="20%">작성자</td>
			<td align="center" width="80%">
			  <input type="text" name="writer" value="${param.writer}" size="60">
			</td>
		  </tr>
		  <tr>
		    <td align="center" width="20%">이메일</td>
			<td align="center" width="80%">
			  <input type="text" name="email" value="${param.email}" size="60">
			</td>
		  </tr>
		  <tr>
		    <td align="center" width="20%">홈페이지</td>
			<td align="center" width="80%">
			  <input type="text" name="homepage" value="${param.homepage}" size="60">
			</td>
		  </tr>
		  <tr>
